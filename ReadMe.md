...
While the description above should provide a good introduction on how to use GitHub Actions there are still some topics open for which we might add some description/examples later:

- [ ] Running dependent jobs one after another (keyword `needs`) ([example](https://github.com/MyTooliT/Documentation-Process/blob/172dbcf4077e3fa6461a1849bfcd09514bd459b9/.github/workflows/bookdown.yaml))
